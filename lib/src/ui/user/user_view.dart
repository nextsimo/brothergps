import 'package:brothergps/src/models/user_model.dart';
import 'package:brothergps/src/ui/user/user_drois_ui.dart';
import 'package:brothergps/src/ui/user/user_provider.dart';
import 'package:brothergps/src/utils/styles.dart';
import 'package:brothergps/src/widgets/buttons/log_out_button.dart';
...
class _BuildTextCell extends StatelessWidget {
  ...
  const _BuildTextCell(this.content, {Key? key}) : super(key: key);
...
class _EditableCell extends StatelessWidget {
  final String content;
  final void Function(String val) onchanged;
  _EditableCell({Key? key, required this.content, required this.onchanged})
      : super(key: key);
